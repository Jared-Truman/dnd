...
* Constants
  ...
  #+RESULTS[2325ced39ab1fcb2ab265f8476707f72d8030235]: define-constants-with-src-block
  :results:
  #+CONSTANTS: STR=15
  #+CONSTANTS: DEX=19
  #+CONSTANTS: CON=17
...
* Abilities and Skills
  ...
  |---------+-------+-----+----+----------------+-----------------------|
  | STR     |    15 |   2 |    | 1d20 + 2       | Saving Throw          |
  |         |       |     |    | 1d20 + 2       | Athletics             |
  |---------+-------+-----+----+----------------+-----------------------|
  | DEX     |    19 |   4 | X  | 1d20 + 7       | Saving Throw          |
  |         |       |     |    | 1d20 + 4       | Acrobatics            |
...
* Attacks
  ...
  |--------------+---------+------+-------------+-----+------------+---------|
  | Light Hammer | STR     | X    | Bludgeoning | 1d4 |          5 | 1d4 + 2 |
